...
- On **large** trees (40 nodes or more) a **minimap** appears in the bottom-left corner: it shows the whole tree and **clicking it takes you there**. Once you zoom in, a rectangle marks what you are looking at; while everything fits on screen it is not drawn, since it would coincide with the frame and say nothing. Small trees do not get one — the tree already fits on screen and it would only take up room.
